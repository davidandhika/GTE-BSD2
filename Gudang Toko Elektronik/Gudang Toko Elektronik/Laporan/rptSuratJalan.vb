...
Public Class rptSuratJalan
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Gudang_Toko_Elektronik.rptSuratJalan.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_kdtranskeluar() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptSuratJalan
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptSuratJalan = New rptSuratJalan()
        rpt.Site = Me.Site
        Return rpt
    End Function
